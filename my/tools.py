...
__all__ = ['get_image_from_url', 'kill', 'get_hash_folder', 'save_selected_cities', 'save_location_dicts',
           'get_top_n_countries', 'path_info', 'rm_r', 'search_notebooks', 'df_chunk_generator', 'LogDBHandler',
           'get_logger', 'read_image_from_url', 'compound_return', 'copy_func', 'patch_to', 'patch', 'to_pickle',
           'from_pickle', 'telegram', 'pdrows', 'pd_highlight', 'inline', 'plot_map', 'htop', 'get_proxies',
           'append_csv', 'repeat_df', 'to_sql', 'timestamp2int', 'pd_timestamp', 'startEndTimestamp', 'pd_set_float',
           'plot_multiple_y', 'sql_head', 'make_clickable', 'selected_countries']
